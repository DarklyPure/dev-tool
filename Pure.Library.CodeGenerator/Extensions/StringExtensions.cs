using Pure.Library.CodeGenerator.Helpers;
...
public static class StringExtensions
{
    ...
    public static DateTimeOffset ToDateTimeOffset(this string value) => DateTimeOffset.TryParse(value, out DateTimeOffset convertedValue) ? convertedValue : default;

    public static DateTimeOffset ToDateTimeOffset(this string value, DateTimeOffset defaultValue) => DateTimeOffset.TryParse(value, out DateTimeOffset dateTimeOffset) ? dateTimeOffset : defaultValue;
